...
namespace NutritionCalculator
{
    public partial class MainForm : Form
    {
        ...
        {
            string sweetFoodJsonFilePath = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.UserProfile), "source\\repos\\NutritionCalculator\\NutritionCalculator\\foodCategories", $"sweetFood.json");
            string foodjsonFilePath = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.UserProfile), "source\\repos\\NutritionCalculator\\NutritionCalculator\\foodCategories", $"food.json");
            string pocketFoodJsonFilePath = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.UserProfile), "source\\repos\\NutritionCalculator\\NutritionCalculator\\foodCategories", $"pocketFood.json");
            string firstDishJsonFilePath = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.UserProfile), "source\\repos\\NutritionCalculator\\NutritionCalculator\\foodCategories", $"firstDish.json");
            string drinkhJsonFilePath = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.UserProfile), "source\\repos\\NutritionCalculator\\NutritionCalculator\\foodCategories", $"drink.json");
