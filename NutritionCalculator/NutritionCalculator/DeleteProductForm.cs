...
namespace NutritionCalculator
{
    public partial class DeleteProductForm : Form
    {
        ...
        private void LoadProductsByCategory(string category)
        {
            ...
            string filePath = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.UserProfile), "source\\repos\\NutritionCalculator\\NutritionCalculator\\foodCategories", fileName);
